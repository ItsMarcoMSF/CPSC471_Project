                  ...
                  <form className="report-form" onSubmit={(e) => reportBug(e)}>
                    <div className="rptrow">
                      ...
                      <div class="col-1 col-s-1">
                        <p>Bug priority</p>
                        <select className="dropdown enter-right" id="priority" onChange={(e) => handle(e)}>
                        ...
                        <br></br>
                        <p>Assign to</p>
                        <select className="enter-right" id="devID" value={sendBug.devID} onChange={(e) => handle(e)} label="Multiple Select" multiple>
                          {createSelectDevs()}
                        </select>
                        <p>Bug deadline</p>
                        <input
