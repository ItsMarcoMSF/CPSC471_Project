              ...
              content={
                <>
                  ...
                  <form className="report-form" onSubmit={(e) => reportBug(e)}>
                    <p className="col-3 col-s-3">Bug name</p>
                    <input
                      className="enter-detail col-3 col-s-3"
                      value={sendBug.name}
                      onChange={(e) => handle(e)}
                      id="name"
                      type="text"
                    ...
                    />
                    <p className="col-3 col-s-3">Bug description</p>
                    <input
                      className="enter-detail col-3 col-s-3"
                    ...
                    />
                    <p className="col-3 col-s-12">Bug priority</p>
                    <select className="dropdown col-3 col-s-12" id="priority" onChange={(e) => handle(e)}>
                    ...
                    <br className="col-3 col-s-12"></br>
                    <select className="col-3 col-s-12" id="devID" value={sendBug.devID} onChange={(e) => handle(e)} label="Multiple Select" multiple>
                      {createSelectDevs()}
                    </select>
                    <p className="col-3 col-s-12">Bug deadline</p>
                    <input
                      className="enter-detail col-3 col-s-12"
